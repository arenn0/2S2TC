        ...
        with tf.name_scope("loss"):
            ...
            with tf.name_scope("precision"):
                ...
                if self.binary:
                    ...
                    self.precision = [self.confusion[i][i] / tf.reduce_sum(np.sum(np.array(self.confusion), axis=0)[i]) for i in
            ...
            with tf.name_scope("recall"):
                ...
                if self.binary:
                    ...
                    self.recall = [self.confusion[i][i] / tf.reduce_sum(np.sum(np.array(self.confusion), axis=1)[i]) for i in
                                   range(self.confusion.shape[0])]  # with tf.name_scope("f1"):
            #  Confusion
